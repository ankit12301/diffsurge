...
COMMENT ON TABLE api_keys IS 'API keys for programmatic access to Diffsurge services';
COMMENT ON COLUMN api_keys.key_prefix IS 'First ~10 chars of key for display (e.g., diffsurge_live_abc...)';
