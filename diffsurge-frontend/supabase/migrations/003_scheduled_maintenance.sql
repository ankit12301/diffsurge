-- ============================================================================
-- Diffsurge — Database Maintenance Jobs
...
0 2 * * 1 psql -U user -d diffsurge_db -c "SELECT * FROM create_next_traffic_partitions(3);"

# Refresh stats every hour
5 * * * * psql -U user -d diffsurge_db -c "SELECT refresh_traffic_stats();"

# Cleanup old partitions on first of month
0 3 1 * * psql -U user -d diffsurge_db -c "SELECT * FROM drop_old_traffic_partitions(90);"
*/
