export const siteConfig = {
  ...
  github: "https://github.com/ankit12301/diffsurge",
  docs: "https://github.com/ankit12301/diffsurge#readme",
} as const;
...
export const faqs = [
  ...
  {
    q: "Does Diffsurge handle sensitive data?",
  ...
  {
    q: "Can I integrate Diffsurge into my existing CI/CD pipeline?",
  ...
  },
  {
    ...
    a: "Diffsurge supports OpenAPI 3.0 and 3.1 (Swagger), GraphQL SDL, gRPC Protocol Buffers, and raw JSON schemas. The diff engine normalises paths and types across formats, so you get consistent breaking-change detection regardless of your API technology.",
  },
  {
    q: "How is the replay engine different from load testing?",
    a: "Load testing checks if your system handles volume. Replay testing checks if your system returns correct responses. Diffsurge replays real production traffic — with real data shapes, edge cases, and parameter combinations — against your staging build and semantically compares every response. It finds the bugs that unit tests and synthetic test suites miss.",
  },
  {
    q: "Is Diffsurge open source?",
