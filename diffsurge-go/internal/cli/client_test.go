...
func TestAPIClient_AddsAuthHeader(t *testing.T) {
	...
	client := NewAPIClient(server.URL, "diffsurge_live_testabc123")

	resp, err := client.Get("/api/v1/health")
	require.NoError(t, err)
	defer resp.Body.Close()

	assert.Equal(t, "diffsurge_live_testabc123", receivedKey)
...
func TestAPIClient_PostSendsBody(t *testing.T) {
	...
	client := NewAPIClient(server.URL, "diffsurge_live_testkey")
...
func TestAPIClient_Handles401(t *testing.T) {
	...
	client := NewAPIClient(server.URL, "diffsurge_live_badkey")
...
func TestAPIClient_Handles403(t *testing.T) {
	...
	client := NewAPIClient(server.URL, "diffsurge_live_limited")
